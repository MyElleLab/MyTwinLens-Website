...
export const metadata: Metadata = {
  ...
  description:
    "Get help with TwinLens. Email support and read answers to common questions about connecting your iPhones, shooting offline, and managing your subscription.",
};
...
const faqs = [
  {
    ...
    answer:
      "Open TwinLens on both phones. Choose Lens on the one you'll place at a distance and Mirror on the one you'll hold. On the Mirror, scan the QR code shown on the Lens or enter its 4 character code. Keep both phones nearby and unlocked; the connection can take a few seconds.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Make sure both phones have Bluetooth on and have granted TwinLens the Local Network and Camera permissions in Settings. Keep the phones close together and unlocked, then try again; the first connection can take up to about 10 seconds.",
  },
  {
    question: "How do I manage or cancel my subscription?",
    answer:
      "Subscriptions are handled by Apple. On your iPhone, open Settings, tap your name at the top, then Subscriptions, and select TwinLens. You can also use Restore Purchases inside the app if a previous subscription isn't showing.",
  },
  {
    question: "Which devices are supported?",
    answer:
      "TwinLens runs on iPhone. You need two iPhones, one as the Lens and one as the Mirror.",
  },
];
          ...
          <article className="space-y-10">
            <header className="space-y-3">
              ...
              <p className="text-tl-muted leading-relaxed">
                Need help with TwinLens? Email us and we&apos;ll get back to you.
              </p>
            </header>
